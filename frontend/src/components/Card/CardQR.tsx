    ...
    <>
      <div className="w-[382px] h-[376px] max-w-xs  bg-[#AE3B57] rounded-lg shadow-lg dark:bg-gray-800 flex  flex flex-col items-center relative">
        <Image
          ...
          src={imageProfile ? imageProfile : "/logoUnla.jpeg"}
          alt="avatar"
          width={60}
          height={60}
        />
        <div className="py-5 text-center mt-5">
          <a
            ...
            className="block text-xl font-bold text-gray-800 text-white dark:text-white "
            role="link"
          >
            {name}
          </a>
          <span className="text-sm text-gray-700 text-white dark:text-gray-200">
            {position}
          </span>
        </div>
        <Image
